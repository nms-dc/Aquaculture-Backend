...
def compute_harvest_analytics(sender, instance, created, *args, **kwargs):
    ...
    if already_exists_cycle.exists():
        ...
        cycle_analytics_instance.harvest_amount += instance.total_kgs
        ...
        CycleAnalytics.objects.create(farm=instance.cycle.Pond.farm,
                                      ...
                                      total_feed=0,
                                      harvest_amount=instance.total_kgs,
    ...
    if already_exists_pond.exists():
        ...
        pond_analytics_instance.harvest_amount += instance.total_kgs
    ...
    if already_exists_farm.exists():
        ...
        farm_analytics_instance.harvest_amount += instance.total_kgs
